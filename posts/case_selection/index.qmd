---
title: "Bullshit, research design, and case selection (1)"
...
Bullshit is most likely a term you are familiar with: Claims or statement that sound kind of plausible but are inherently erroneous and misleading [@Bergstrom2021]. Bullshit can be intentional, which happens when someone tries to mislead someone, but it can also happen by accident. In either case, bullshit can do serious harm: It can lead people (or companies and institutions) to make decisions that cost them real money, and it can lead them to *avoid* decisions that would be beneficial. This can range from buying a used car with lots of hidden defects to basing a company's marketing strategy on biased and misleading customer data.
