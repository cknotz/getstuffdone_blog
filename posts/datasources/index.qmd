...
### Election/voter survey data
 ...
 - Comparative National Elections Project (CNEP; <https://www.upf.edu/web/cnep>): coordinated election studies across diverse political systems worldwide, using a common core questionnaire to achieve comparability. It includes 74 surveys from the 1990s to 2025 in 30 different countries and Hong Kong, spanning five continents with a focus on traditional voting behavior measures and the role of intermediaries. The data focus in particular on political polarization, populism, support for democracy and political intermediation.
...
### Technology & AI
 ...
 - [Exposure to Generative AI](https://github.com/pgmyrek/2025_GenAI_scores_ISCO08): Indicators measuring exposure to generative AI for ISCO-08 occupations (can be merged with e.g., data from the *European Social Survey* or *International Social Survey Program*). See also @Gmyreketal2025 and @Gmyreketal2023 for details.
...
### Comparative politics: Governments, parliaments, parties, institutions, elections
 ...
 - Political Party Database: Quantitative data on party resources, party decision processes, and the outcome of decision-making procedures for parties in many representative democracies, and archived party statutes (<https://www.politicalpartydb.org/>).
